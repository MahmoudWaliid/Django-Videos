...
def new_employee(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            wb = load_workbook(r'C:\Users\East-Sound\Desktop\Django Projects\Video_10\Employees.xlsx')
            ws = wb['emp']
            ...
            wb.save(r'C:\Users\East-Sound\Desktop\Django Projects\Video_10\Employees.xlsx')
